...
namespace Application.Extensions
{
    public static class Extensions
    {
        ...
        public static ObjectId ParseObjectId(this string objectIdString)
        {
            if (ObjectId.TryParse(objectIdString, out ObjectId result))
            {
                return result;
            }
        ...
        public static ObjectId ParseObjectIdOrNew(this string objectIdString)
        {
            if (ObjectId.TryParse(objectIdString, out ObjectId result))
            {
                return result;
        ...
        public static string ToStringOrEmpty(this ObjectId objectId)
        {
