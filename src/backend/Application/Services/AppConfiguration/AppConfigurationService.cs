                ...
                Grids = new List<UserConfigurationGridItem>
                {
                    ...
                    new UserConfigurationGridItem
                    {
                        ...
                        Columns = new List<UserConfigurationGridColumn>
                        {
                            ...
                            new UserConfigurationGridColumn(nameof(OrderDto.ArrivalTimeForLoadingBDFWarehouse), FiledType.DateTime),
                            new UserConfigurationGridColumn(nameof(OrderDto.DepartureTimeFromTheBDFWarehouse), FiledType.DateTime),
                            new UserConfigurationGridColumn(nameof(OrderDto.ActualDateOfArrivalAtTheConsignee), FiledType.DateTime),
                            new UserConfigurationGridColumn(nameof(OrderDto.ArrivalTimeToConsignee), FiledType.Text),
                            new UserConfigurationGridColumn(nameof(OrderDto.DateOfDepartureFromTheConsignee), FiledType.DateTime),
                    ...
                    new UserConfigurationGridItem
                    {
                        ...
                        Columns = new List<UserConfigurationGridColumn>
                        {
                            ...
                            new UserConfigurationGridColumn(nameof(ShippingDto.ArrivalTimeForLoadingBDFWarehouse), FiledType.DateTime),
                            new UserConfigurationGridColumn(nameof(ShippingDto.DepartureTimeFromTheBDFWarehouse), FiledType.DateTime),
